...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      >
        <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-blue-500/10 border border-blue-500/30 flex items-center justify-center group-hover:bg-blue-500/20 group-hover:border-blue-500/50 transition-all duration-300">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center justify-center gap-3 mb-4 sm:mb-6">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl flex items-center justify-center shadow-2xl shadow-blue-500/30 animate-float">
        ...
        {/* Login Card */}
        <div 
          className={`w-full max-w-[480px] bg-slate-800/50 border border-blue-500/20 rounded-xl sm:rounded-2xl shadow-2xl shadow-blue-500/10 p-6 sm:p-8 transition-all duration-700 ${
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            ...
            <Button
              type="submit"
              className={`w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold h-11 sm:h-12 rounded-lg shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] text-sm sm:text-base ${
                isMounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
              }`}
          ...
          {/* Demo credentials */}
          <div 
            className={`mt-5 sm:mt-6 p-3 sm:p-4 bg-blue-500/10 rounded-xl border border-blue-500/20 transition-all duration-500 ${
              isMounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
            }`}
